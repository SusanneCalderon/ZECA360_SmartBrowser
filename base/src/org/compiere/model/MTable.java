...
public class MTable extends X_AD_Table
{
	...
	//F3P: 'final' removed to enable custom modification from  addCustomPackages()
	private static /*final*/ String[]	s_packages = new String[] {
	//(AV)private static final String[]	s_packages = new String[] {
	...
	/**
	 * Use this method for add custom packages where Adempiere will try to find Model.
	 * 
	 * @param sNewPackages
	 */
